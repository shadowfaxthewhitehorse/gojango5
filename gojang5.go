...
//
// The crossProduct function calculates the cross product of two vectors formed by three points, which is used to determine the orientation of the points 
...
// product is positive). If they turn right (cross product is negative or zero), it removes the most recently added point from the hull until the new point 
// can be added without turning right. The result is a slice of Points representing the Convex Hull.
//
